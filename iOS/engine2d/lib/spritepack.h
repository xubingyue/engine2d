...
#ifndef __engine2d__spritepack__
#define __engine2d__spritepack__
...
#define SIZEOF_PICTURE (sizeof(struct pack_picture))
...
int engine2d_spritepack(lua_State *L);
...
#endif /* defined(__engine2d__spritepack__) */
