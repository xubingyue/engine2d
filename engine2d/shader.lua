print("engine2d/shader.lua  loading..")
local s = require "engine2d.shader.c"
...
function shader.material_meta(prog)
	print("shader.material_meta-----called.....")
